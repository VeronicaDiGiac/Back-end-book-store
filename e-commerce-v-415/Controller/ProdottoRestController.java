...
public class ProdottoRestController {
	...
	@Operation(summary = "ottieni autore per nome", description = "Restituisce una lista di autori che corrispondono al nome dato")
	...
	@GetMapping("/generi")
	@Operation(summary = "Ottieni tutti i generi", description = "Restituisce una lista di tutti i generi che corrispondono al genere dato")
