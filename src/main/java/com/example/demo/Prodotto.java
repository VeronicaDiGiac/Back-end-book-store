...
public class Prodotto {
    ...
    @Column(name = "annoPubblicazione")  // Specifica il nome corretto
...
public Prodotto(String titolo, String autore, String casaEditrice,String annoPubblicazione,String genere,String url,double prezzo,int quantita, String descrizione){
	...
	public String toString() {
		return "Prodotto [titolo=" + titolo + ", autore=" + autore + ", casaEditrice=" + casaEditrice
				+ ", annoPubblicazione=" + annoPubblicazione + ", genere=" + genere + ", prezzo=" + prezzo
				+ ", quantita=" + quantita + ", quantitaV=" + quantitaV + "]";
	} 
	   @Override
